...
object Dog {
  final case class SYNTHETIC_NAME(value: Husky) extends Dog
  final case class SYNTHETIC_NAME(value: York) extends Dog
  final case class SYNTHETIC_NAME(name: String, age: Double, gender: Option[Gender]) extends Dog
  object SYNTHETIC_NAME {
...
object Pet {
  final case class SYNTHETIC_NAME(value: Cat) extends Pet
  final case class SYNTHETIC_NAME(value: Dog) extends Pet
}

sealed trait Strnum extends Product with Serializable

object Strnum {
  final case class SYNTHETIC_NAME(value: String) extends Strnum
  final case class SYNTHETIC_NAME(value: Double) extends Strnum
}
